							...
							<div class="col-lg-12">
								<form method="post" id="login-form"  role="form" style="display: block;">
									<div class="form-group">
										<input type="email" name="email" id="username" tabindex="1" class="form-control" placeholder="Email Id"  required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												...
												<input type="button" name="login-submit" id="loginsubmit" tabindex="4"  value="Log In" style="padding-left:5px;padding-right:5px;background-color: orange;">
												</div>
											</div>
										</div>
									</div>
