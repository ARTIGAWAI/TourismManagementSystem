						...
						<div class="row">
							<div class="col-lg-12">
								<form action="../Register" method="post" onsubmit="return validation()" id="login-form" role="form" style="display: block;">
									...
									<div class="form-group">
										<input type="email" name="email" id="email" tabindex="2" class="form-control" placeholder="Email ID"
										 required="required" >
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="tel" name="mobile" id="mobile" tabindex="4" class="form-control" placeholder="Mobile" >
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register" id="login-submit" tabindex="5" class="form-control btn btn-login" style="border: 1px ;
  padding: 10px; box-shadow: 5px 10px 8px skyblue;"  value="Register"
												>
											</div>
										</div>
									</div>
